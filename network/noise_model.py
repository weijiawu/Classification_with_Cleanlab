...
class CNN(BaseEstimator):  # Inherits sklearn classifier
    ...
    def fit(self, train_idx=None, train_labels=None, sample_weight=None, loader='train'):
        ...
        ** All inputs should be numpy arrays, not pyTorch Tensors
        ...
        traindir = os.path.join("/data/glusterfs_cv_04/11121171/data/CIFAR/CIFAR10-noise", 'train')
    ...
    def predict_proba(self, idx=None, loader=None):
        ...
        if loader == 'train':
            valdir = os.path.join("/data/glusterfs_cv_04/11121171/data/CIFAR/CIFAR10-noise", 'train')
        else:
            valdir = os.path.join("/data/glusterfs_cv_04/11121171/data/CIFAR/CIFAR10-noise", 'test')
...
if __name__ == "__main__":
    ...
    lnl = LearningWithNoisyLabels(clf=CNN())
    train_data = list(range(50000))
    labels = np.array([label for img, label in
              datasets.ImageFolder(
                  os.path.join("/data/glusterfs_cv_04/11121171/data/CIFAR/CIFAR10-noise", "train")).imgs])

    lnl.fit(np.array(train_data),labels)
